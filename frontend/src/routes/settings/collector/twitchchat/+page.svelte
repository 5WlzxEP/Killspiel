    ...
    <div class="card w-full">
        ...
        <form class="p-5" on:submit|preventDefault={submit}>
            <div class="grid lg:!grid-cols-2 gap-10 w-full m-2">
                ...
                <InputText bind:value={d.channel} label="Twitch Channel" prefix="twitch.tv/" required={true} placeholder="5W_lzxEP"
                           modal={{title: "Twitch Channel", body: "Dies ist der Twitchchannel mit dessen Chat interagiert wird."}} />

                <InputText bind:value={d.prefix} label="Prefix" placeholder="/guess"
                ...
                <InputArea bind:value={d.msgBegin} label="Nachricht zum Begin der Erhebung" placeholder="/announceblue Das Killspiel hat begonnen. Nimm jetzt Teil mit /guess <Dein Guess>."
                ...
                <InputArea bind:value={d.msgEnd} label="Nachricht zum Ende der Erhebung" placeholder="/announceorange Das Voten ist abgeschlossen. Ab jetzt bitte keine Stimmen in der Chat mehr."
                    modal={{title: 'Nachricht zum Ende der Erhebung', body: 'Diese Nachricht wird zum Ende der Erhebung in den Chat gepostet. <br> ' +
                        'Es können Twitchfeatures wie /announce genutzt werden, jedoch sind für diese eventuell Rechte nötig.'}} />

                <InputArea bind:value={d.msgFinal} label="Nachricht zum Auflösen der richtigen Schätzungen" placeholder="/announcegreen Das Killspiel ist beendet. Es wurden $RESULT Kills erzielt und somit haben $WINNERS gewonnen."
